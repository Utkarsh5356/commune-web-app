...
export default function SignInInput() {
  ...
  return (
    <div className="min-h-screen bg-[#313338] flex items-center w-screen justify-center px-4">
        ...
        {!pendingVerification ? (
          <>
            <div className="text-center space-y-1">
              ...
              <p className="text-sm text-zinc-400">We're excited to see you again!</p>
            </div>
            ...
            >
              {loading ? <><Loader2 className="w-4 h-4 animate-spin" />Sending code…</> : "Continue"}
            </Button>
          ...
          <>
            ...
            <Button
              ...
              className="w-full h-10 bg-indigo-600 hover:bg-indigo-500 text-white
                disabled:opacity-50 flex items-center justify-center gap-2"
            >
              {loading ? <><Loader2 className="w-4 h-4 animate-spin" />Verifying…</> : "Submit"}
            </Button>
          </>
        )}
      </Card>
