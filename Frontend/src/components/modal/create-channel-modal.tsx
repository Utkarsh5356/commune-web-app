import { useChannelCreate } from "@/hooks/channel/use-channel-create"
             ...
             <div className="space-y-8 px-6">
                <FormField
                  ...
                  render={({field})=>(
                    <FormItem>
                      <FormLabel 
                        className="uppercase text-xs font-bold text-zinc-700">
                        Channel Name
                      </FormLabel>
                      <FormControl>
                        <Input 
                ...
                <FormField
                  ...
                  render={({ field })=>(
                    <FormItem>
                      <FormLabel className="uppercase text-xs font-bold text-zinc-700">Channel Type</FormLabel>
                      <Select
                        disabled={isLoading}
